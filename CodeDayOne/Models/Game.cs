...
namespace CodeDayOne.Models
{
    public class Game
    {
        ...
        {
            var Ahri = new Champion("Ahri", 526, 66, 53, 20, 30, 200);
            ...
            var Caitlyn = new Champion("Caitlyn", 475, 56, 62, 32, 30, 125);
            ...
            var Darius = new Champion("Darius", 582, 62, 64, 39, 32, 85);
            ...
            var Draven = new Champion("Draven", 200, 20, 30, 20, 15, 20);
            ...
            var Gragas = new Champion("Gragas", 583, 62, 61, 35, 32, 90);
            ...
            var Lux = new Champion("Lux", 490, 62, 53, 18, 30, 180);
            ...
            var Malphite = new Champion("Malphite", 574, 63, 61, 37, 32, 90);
            ...
            var Sona = new Champion("Sona", 100, 10, 10, 12, 20, 40);
